...
class GAN(object):
    ...
    def __init__(self, num_of_corpus=3, batch_size=50, seed=1):
    ...
    def test_gan(self, n_preepochs=100, n_epochs=500, save=False, output='result/cluster/gan-1.out'):
        ...
        for epoch in range(n_preepochs):
            ...
            for minibatch_index in range(n_train_batches):
                _ = train_classifier(ind, 0.0, 1.0, lr, lr, lr)
