...
class GAN(object):
    ...
    def __init__(self, num_of_corpus=6, batch_size=50, n_noise=100, seed=123):
    ...
    def test_gan(self, n_epochs=500, n_post_epochs=500, save=False, output='result/gan/gan-123.out'):
